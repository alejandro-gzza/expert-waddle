                        ...
                        <span>
                            ...
                            <p style="color:#000000; font-size: 10px; text-transform: uppercase; text-align:left; ">
                                <strong>
                                        ...
                                        <b style="border-bottom: 1.5pt solid #000000;">  RENOVAMOS NUESTRA CUENTA BANCARIA PARA DEPÓSITOS Y TRANSFERENCIAS
                                     ELECTRÓNICAS. </b> </p>
                                ...
                                <div
                                    style="color:#4CAF50; font-size: 18px;  width: auto;  height: auto; margin-bottom: 10px; border-bottom: 10px; display: block; ">
                                        ...
                                        <strong style=" font-size: 13px; ">
                                            ...
                                            <b
                                                style="color:#ffcc00;  font-size: 14px; ">
                                                EMPIEZA A UTILIZAR ESTA CUENTA PARA REALIZAR TODOS TUS PAGOS. 
                                           </b>
                                    
                                            <br>

                                            <b style="color:#ffffff; font-size: 13px; text-align:center;  ">DESCARGA EL DOCUMENTO CON EL DETALLE DE LOS MÉTODOS DE PAGO ELECTRÓNICOS EN
                                            EL SIGUIENTE ENLACE: 
                                            </b> 
